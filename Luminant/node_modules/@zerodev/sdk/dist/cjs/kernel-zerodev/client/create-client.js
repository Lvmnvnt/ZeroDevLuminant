...
const createZeroDevPublicErc4337Client = ({ chain, rpcUrl, projectId, bundlerProvider, }) => {
    const erc4337Transport = (0, viem_1.http)(rpcUrl, {
        fetchOptions: {
            headers: rpcUrl === constants_js_1.BUNDLER_URL ? { projectId, bundlerProvider } : {},
        },
    ...
    const publicTransport = (0, viem_1.http)(constants_js_1.CHAIN_ID_TO_NODE[chain.id]);
