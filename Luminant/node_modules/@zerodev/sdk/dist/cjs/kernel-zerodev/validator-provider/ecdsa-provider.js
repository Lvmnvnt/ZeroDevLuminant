...
class ECDSAProvider extends base_js_1.ValidatorProvider {
    constructor(params) {
        ...
        const validator = new ecdsa_validator_js_1.ECDSAValidator({
