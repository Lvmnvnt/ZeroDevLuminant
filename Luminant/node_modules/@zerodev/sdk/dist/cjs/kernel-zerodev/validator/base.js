...
class KernelBaseValidator {
    constructor(params) {
        ...
        this.validatorAddress = params.validatorAddress ?? constants_js_1.ECDSA_VALIDATOR_ADDRESS;
        this.mode = params.mode ?? ValidatorMode.sudo;
        this.entryPointAddress = params.entryPointAddress ?? constants_js_1.ENTRYPOINT_ADDRESS;
        ...
        this.rpcUrl = params.rpcUrl ?? constants_js_1.BUNDLER_URL;
        this.publicClient = (0, viem_1.createPublicClient)({
            transport: (0, viem_1.http)(constants_js_1.CHAIN_ID_TO_NODE[this.chain?.id ?? chains_1.polygonMumbai.id]),
    ...
    async getDynamicDummySignature(kernelAccountAddress, calldata) {
        ...
        if (validatorMode === ValidatorMode.enable) {
            ...
            const staticDummySig = (0, viem_1.concatHex)([
            ...
            return (0, viem_1.concatHex)([
                ...
                enableData,
                (0, viem_1.pad)((0, viem_1.toHex)(enableSigLength), { size: 32 }),
                dummyECDSASig,
    ...
    async approveExecutor(kernel, selector, executor, validUntil, validAfter, validator) {
        ...
        const ownerSig = await signer.signTypedData({
            domain: {
                name: "Kernel",
                version: kernelImplAddr?.toLowerCase() === constants_js_1.KERNEL_IMPL_ADDRESS.toLowerCase() ||
                    kernelImplAddr?.toLowerCase() ===
                        "0x8dD4DBB54d8A8Cf0DE6F9CCC4609470A30EfF18C".toLowerCase() ||
                    kernelImplAddr === undefined ||
                    kernelImplAddr === viem_1.zeroAddress
                    ? "0.2.2"
                    : "0.2.1",
    ...
    async getSignature(userOp) {
        ...
        if (mode === ValidatorMode.sudo || mode === ValidatorMode.plugin) {
            return (0, viem_1.concatHex)([this.mode, await this.signUserOp(userOp)]);
        }
        else {
            ...
            return (0, viem_1.concat)([
                mode,
                (0, viem_1.pad)((0, viem_1.toHex)(this.validUntil), { size: 6 }),
                (0, viem_1.pad)((0, viem_1.toHex)(this.validAfter), { size: 6 }),
                (0, viem_1.pad)(this.validatorAddress, { size: 20 }),
                (0, viem_1.pad)(this.executor, { size: 20 }),
                (0, viem_1.pad)((0, viem_1.toHex)(enableDataLength), { size: 32 }),
                enableData,
