...
import { concatHex, encodeAbiParameters, encodeFunctionData, getContract, parseAbiParameters, createWalletClient, http, custom, publicActions, getFunctionSelector, } from "viem";
...
export class RecoveryValidator extends KernelBaseValidator {
    ...
    static async fetchRecoveryConfigFromContract(kernelAccountAddress, publicClient) {
        try {
            ...
            while (nextGuardian.toLowerCase() !== kernelAccountAddress.toLowerCase()) {
