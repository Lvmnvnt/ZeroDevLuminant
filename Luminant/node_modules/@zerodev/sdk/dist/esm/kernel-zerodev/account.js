import { concatHex, encodeFunctionData, hashMessage, toBytes, } from "viem";
...
export function isKernelAccount(account) {
...
export class KernelSmartContractAccount extends BaseSmartContractAccount {
    ...
    async encodeBatchExecute(_txs) {
        ...
        const shouldUseMultiSend = kernelImplAddr?.toLowerCase() !== KERNEL_IMPL_ADDRESS.toLowerCase() &&
    ...
    async signMessageWith6492(msg) {
        try {
            ...
            let signature = await this.validator.signMessage(toBytes(hashMessage({ raw: formattedMessage })));
